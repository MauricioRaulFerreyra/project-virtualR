...
const Pricing = () => {
  return (
    <section className='mt-20'>
      <h2 className='my-8 text-center text-3xl tracking-wider sm:text-5xl lg:text-6xl'>Pricing</h2>
        ...
        {pricingOptions.map((option, index) => (
          <div key={index} className='w-full p-2 sm:w-1/2 lg:w-1/3'>
            <div className='rounded-xl border border-neutral-700 p-10'>
              ...
              <a
                href='#'
                className='mt-20 inline-flex h-12 w-full items-center justify-center rounded-lg border border-orange-900 p-5 text-center text-xl tracking-tight transition duration-200 hover:bg-orange-900'
              >
                Subscribe
              </a>
            </div>
